...
async function main() {
	try {
		...
		try {
			...
			result = await contract.submitTransaction('CreateAsset', '1801008', 'Amirtha', 'CSE', '2018', 'QmZBwuDJBN2wevZWFMbZqAxmNJwfi5rop71Vb6GxHh9zNM');
			...
			result = await contract.evaluateTransaction('ReadAsset', '1801008');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);

			console.log('\n--> Evaluate Transaction: AssetExists, function returns "true" if an asset with given assetID exist');
			result = await contract.evaluateTransaction('AssetExists', '1801050');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);

			console.log('\n--> Submit Transaction: UpdateAsset asset1, change the certificate hash');
			await contract.submitTransaction('UpdateAsset', '1801008', 'Amirtha', 'CSE', '2018', 'QmbodDAMT3FxwCHQqrmcYQcri2NA6kYmanbURUp9pjqiDC');
			console.log('*** Result: committed');

			console.log('\n--> Evaluate Transaction: ReadAsset, function returns "asset1" attributes');
			result = await contract.evaluateTransaction('ReadAsset', '1801050');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			...
			try {
				...
				await contract.submitTransaction('UpdateAsset', '1801064', 'Varshini', 'CSE', '2018', 'QmbodDAMT3FxwCHQqrmcYQcri2NA6kYmanbURUp9pjqiDC');
